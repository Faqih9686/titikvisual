        ...
        <form action="{{ route('contact.submit') }}" method="POST">
          ...
          <div>
            ...
            <div class="flex items-center border rounded-lg px-3 py-2 bg-white">
              ...
              <input type="text" name="name" id="name" value="{{ old('name') }}" required class="w-full outline-none" placeholder="Masukkan nama lengkap" />
          ...
          <div>
            ...
            <div class="flex items-center border rounded-lg px-3 py-2 bg-white">
              ...
              <input type="email" name="email" id="email" value="{{ old('email') }}" required class="w-full outline-none" placeholder="nama@email.com" />
          ...
          <!-- WhatsApp -->
          <div>
            <label for="phone" class="block text-sm font-medium mb-1">No. WhatsApp *</label>
            <div class="flex items-center border rounded-lg px-3 py-2 bg-white">
              <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <input type="text" name="phone" id="phone" value="{{ old('phone') }}" class="w-full outline-none" placeholder="08xxxxxxxxxx" />
          ...
          <!-- Nama Perusahaan -->
          <div>
            <label for="namept" class="block text-sm font-medium mb-1">Nama Perusahaan</label>
            <div class="flex items-center border rounded-lg px-3 py-2 bg-white">
              <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <input type="text" name="namept" id="namept" value="{{ old('namept') }}" required class="w-full outline-none" placeholder="PT. Nama Perusahaan" />
              @error('namept') <small class="text-danger">{{ $message }}</small> @enderror
            </div>
          </div>

          <!-- Layanan -->
          <div>
            <label for="layanan" class="block text-sm font-medium mb-1">Layanan yang Dibutuhkan *</label>
            <div class="flex items-center border rounded-lg px-3 py-2 bg-white">
              <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <select name="layanan" id="layanan" required class="w-full outline-none bg-white">
          ...
          <!-- Timeline -->
          <div>
            <label for="timeline" required class="block text-sm font-medium mb-1">Timeline Proyek</label>
            <div class="flex items-center border rounded-lg px-3 py-2 bg-white">
              <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <select name="timeline" id="timeline" required class="w-full outline-none bg-white">
          ...
          <!-- Budget -->
          <div class="md:col-span-2">
            <label for="budget" class="block text-sm font-medium mb-1">Budget Range</label>
            <div class="flex items-center border rounded-lg px-3 py-2 bg-white">
              <input type="text" name="budget" id="budget" value="{{ old('budget') }}" required class="w-full outline-none" placeholder="Pilih budget range" />
          ...
          <!-- Detail Proyek -->
          <div class="md:col-span-2">
            <label for="message" class="block text-sm font-medium mb-1 text-gray-700">
            ...
            <div class="border rounded-lg px-3 py-2 bg-white">
              <textarea name="message" id="message" rows="4" class="w-full outline-none resize-none"
                placeholder="Ceritakan detail proyek/kebutuhan merchandise Anda, tujuan bisnis, target audience, spesifikasi produk, quantity, referensi design, dll.">{{ old('message') }}</textarea>
